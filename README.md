...
Como apoyo mínimo, existe un smoke test en `tests/test_smoke_flows.py` que valida los flujos básicos de creación, consulta, cambio de base de datos, backup, restore, gestión de contraseñas, integridad y borrado usando dobles de base de datos.
